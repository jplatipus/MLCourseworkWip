classdef NBayesResults < handle
  ...
  properties
    resultsTable = {};
    resultsColumnNames = [
      "distributionName", "smootherType", "Width", "numberOfHoldOutRun", ...
      "randomTreebagSeed", "avgTrainLoss", ...
      "avgTestLoss", ...
  ...
  methods
    ...
    function appendResult(obj, distributionName, smootherTypeName, width, ...
                  numberOfHoldOutRun, randomSeed, avgTrainLoss, avgTestLoss, ...
                  avgAccuracy, avgPrecision, avgRecall, avgF1, ...
                  entryCount, elapsedTime)
      if obj.fileHandle == -1
      ...
      fprintf(obj.fileHandle, "%s\t%s\t%0.08f\t%d\t%d\t%0.04f\t%0.04f\t%0.04f\t%0.04f\t%0.04f\t%0.04f\t%d\t%0.04f\n", ...
               distributionName, smootherTypeName, width, ... 
               numberOfHoldOutRun, randomSeed, ...
