classdef NBayesResults < handle
  ...
  properties
    resultsTable = {};
    resultsColumnNames = [
      "distributionName", "Width", "numberOfHoldOutRun", "avgTrainAccuracy", ...
      "avgTestAccuracy", "avgMisclassifiedEntryCount", ...
  ...
  methods
    ...
    function appendResult(obj, distributionName, width, ...
      ...
      fprintf(obj.fileHandle, "%s\t%0.04f\t%d\t%0.04f\t%0.04f\t%02f\t%0.04f\t%0.04f\t%0.04f\t%0.04f\t%d\t%0.04f\n", ...
